...
<head>
    ...
    <title>▶ Encuentra las mejores camisas de musica </title>
    <meta name ="description" content = "🔴 Entra y elige las camisas de musica que mas te gusten al mejor precio">
</head>
...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="display-3 text-center">Camisas</h1>
