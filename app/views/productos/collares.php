...
<head>
    ...
    <title>▶ Encuentra los mejores collares de musica </title>
    <meta name ="description" content = "🔴 Entra y elige los collares de musica que mas te gusten al mejor precio">
</head>
...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="display-3 text-center">Collares</h1>
