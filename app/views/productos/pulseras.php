...
<head>
    ...
    <title>▶ Encuentra las mejores pulseras de musica </title>
    <meta name ="description" content = "🔴 Entra y elige las pulseras de musica que mas te gusten al mejor precio">
</head>
...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="display-3 text-center">Pulseras</h1>
        ...
        <script>createNavbar('accesorios');</script>
</body>
