...
<head>
    ...
    <title>▶ Encuentra los mejores leggins de musica </title>
    <meta name ="description" content = "🔴 Entra y elige los leggins de musica que mas te gusten al mejor precio">
</head>
...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="display-3 text-center">Leggins</h1>
