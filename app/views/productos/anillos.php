...
<head>
    ...
    <title>▶ Encuentra los mejores anillos de musica </title>
    <meta name ="description" content = "🔴 Entra y elige el anillo de musica que mas te guste al mejor precio">
...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="display-3 text-center">Anillos</h1>
